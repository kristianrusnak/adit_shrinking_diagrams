...
import {useSendMessageMutation, useSendMockMutation, useCreateThreadAndSendPromptMutation, useSendPromptToThreadMutation} from "../../api/dbApi"; // or your real send function
